...
export class DODExpertCharacterTokenHUD extends BasePlaceableHUD {

    /** @inheritDoc */
    static get defaultOptions() {
      return foundry.utils.mergeObject(super.defaultOptions, {
        id: "token-hud",
        template: "systems/dodexpert/templates/hud/expert-token-hud.html"
      });
    }
  ...
  const tokenMappings = {
    character: DODExpertCharacterTokenHUD,
    npc: DODExpertCharacterTokenHUD,
    default: DODExpertCharacterTokenHUD
  };
