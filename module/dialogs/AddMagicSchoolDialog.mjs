...
export class AddMagicSchoolDialog extends FormApplication {


  constructor(data) { // myObject is the object your app modifies, such as an Actor or Item
    super(data, { title: 'Välj magiskola'});
    this.data = data;
  ...
  static get defaultOptions() {
    ...
    const overrides = {
      ...
      submitOnChange: true,
      template: "systems/dodexpert/templates/dialog/add-magic-school-dialog.html",
